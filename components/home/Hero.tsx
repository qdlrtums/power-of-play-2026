...
export function Hero() {
  return (
    <section className="relative px-3 pb-8 pt-8 sm:px-5 lg:pb-12 lg:pt-12" aria-labelledby="hero-heading">
      ...
      <div className="on-forest relative mx-auto max-w-[88rem] rounded-[var(--radius-lg)] bg-forest px-5 pb-20 pt-16 text-center shadow-hero sm:px-10 sm:pb-24 sm:pt-20 lg:px-16 lg:pb-28 lg:pt-24">
        ...
        <Reveal delay={0.45} className="relative z-10 mx-auto mt-8 max-w-4xl px-2 sm:mt-10 lg:mt-12">
          <NewsletterCard />
        </Reveal>
      </div>
    </section>
