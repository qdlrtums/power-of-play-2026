/* ==========================================================================
   SHARED POOL — components workbench
   The two green dials, a live ramp, and a copy-out of the token block to
   paste back into the variant's theme.css.
   ========================================================================== */
(function () {
  var root = document.documentElement;
  var variant = root.getAttribute("data-variant") || "default";
      ...
      copyBtn.addEventListener("click", function () {
        ...
        if (navigator.clipboard && navigator.clipboard.writeText) {
          navigator.clipboard.writeText(block).then(
            ...
            function () {
              window.prompt("Copy this into theme.css:", block);
            }
          );
        } else {
          window.prompt("Copy this into theme.css:", block);
