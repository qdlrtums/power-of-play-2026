/* Shared site behaviour: colour-scheme toggle, plus the tuned green applied on
   every page so the Components workbench previews the real site. */
(function () {
  var THEME_KEY = "pop:theme";
  var TOKEN_KEY = "pop:green";
  ...
  function applyGreen() {
    ...
    try {
      ...
      /* A corrupt entry just means we fall back to the file defaults. */
    }
  }
